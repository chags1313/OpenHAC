    ...
    def setupUi(self, MainWindow):
      ...
      #  self.menuAnnotate = QtWidgets.QMenu(self.menuTools)
       # self.menuAnnotate.setObjectName("menuAnnotate")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resources/icons8-new-copy-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew_Project.setIcon(icon1)
        self.actionNew_Project.setObjectName("actionNew_Project")
        self.actionSave_Project = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("resources/icons8-download-resume-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_Project.setIcon(icon2)
        self.actionSave_Project.setObjectName("actionSave_Project")
        #self.actionLoad_Project = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resources/icons8-unload-cargo-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        #self.actionLoad_Project.setIcon(icon3)
        #self.actionLoad_Project.setObjectName("actionLoad_Project")
        self.actionAbout = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("resources/icons8-help-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon4)
        self.actionAbout.setObjectName("actionAbout")
        self.actionDataframeview = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("resources/icons8-data-sheet-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDataframeview.setIcon(icon5)
        self.actionDataframeview.setObjectName("actionDataframeview")
        self.actionHelp = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("resources/icons8-high-importance-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHelp.setIcon(icon6)
        self.actionHelp.setObjectName("actionHelp")
        self.actionLoad = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("resources/icons8-upload-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLoad.setIcon(icon7)
        self.actionLoad.setObjectName("actionLoad")
        self.actionTrain = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("resouces/icons8-development-skill-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
       ...
       # self.actionLoad_class.setObjectName("actionLoad_class")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("resources/icons8-launch-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("resources/icons8-face-id-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
       # self.actionHead_motion = QtWidgets.QAction(MainWindow)
        ...
        self.actionPose_analysis = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("resources/icons8-exercise-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("resources/icons8-tree-structure-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("resources/icons8-heart-with-pulse-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("resources/icons8-video-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("resources/icons8-scatter-plot-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
